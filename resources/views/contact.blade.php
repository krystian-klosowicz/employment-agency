        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="margin-top:10vh;">
                    <div class="card-header text-center">Wyślij prośbę o dodanie ogłoszenia</div>
                    ...
                    padding: 40px 50px 45px;">
                        <form method="POST" action="{{ route('contact.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="salary" type="number" step="1" min="0"
                            ...
                            <div class="form-group row">
                                <label for="tel" class="col-md-4 col-form-label text-md-right">Numer
                                    telefonu</label>
